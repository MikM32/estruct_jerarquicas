...
class List{
    ...
    private:
        ...
        NodeList<type>* partition(NodeList<type>* first, NodeList<type>* last)
        {
            NodeList<type>* pivot = last;
            NodeList<type>* i = first->getPrevious();

            NodeList<type>* cur = first;
            while(cur != NULL)
            {
                if(cur == last || !last)
                {
        ...
        void quickSort(NodeList<type>* first, NodeList<type>* last)
        {
            if(last != NULL && first != last && first != last->getNext())
            {
                NodeList<type>* part = partition(first, last);
        ...
        void swap(NodeList<type>* a, NodeList<type>* b)
        {
            type aux = a->getValue();
    ...
    public:
        ...
        ~List()
        {
            if(this->size)
            {
                NodeList<type>* acum = this->first, *basura;
                while(acum != NULL)
                {
                    basura = acum;
                    acum = acum->getNext();
        ...
        void insertAtIndex(int index, type value){
            ...
            else
            {
                ...
                NodeList<type> * node = new NodeList<type>(value);
        ...
        void insertAtFirst(type value){
            NodeList<type> * newNode = new NodeList<type>(value);
        ...
        void reverse()
        {
            NodeList<type>* left = this->first, *right = this->last;
